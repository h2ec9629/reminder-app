...
# Push index.html, style.css, ui.js, sw.js to H2EC9629/reminder-app (main)
...
$Files = @("index.html", "style.css", "ui.js", "sw.js")
...
try {
    ...
    foreach ($FilePath in $Files) {
        ...
        $body = @{
            message = "$FilePath: add ring-menu top screen (Wm2B center)"
