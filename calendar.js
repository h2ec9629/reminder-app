...
function renderGantt() {
  ...
  const TODAY_ISO = (_ganttData && _ganttData.view_date)
    ? _ganttData.view_date
    : (()=>{ const _td = new Date(); return `${_td.getFullYear()}-${String(_td.getMonth()+1).padStart(2,'0')}-${String(_td.getDate()).padStart(2,'0')}`; })();
