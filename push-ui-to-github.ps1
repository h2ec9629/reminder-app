# =======================================================
# push-ui-to-github.ps1
# Push ui.js to H2EC9629/reminder-app (main) via GitHub Contents API.
...
$LocalFile = "C:\Users\mmtm9\Desktop\dev\reminder-app-main\ui.js"
...
try {
    ...
    $body = @{
        message = "ui.js: schedule tab now mirrors haiso.html (current week only, box name + supply qty)"
